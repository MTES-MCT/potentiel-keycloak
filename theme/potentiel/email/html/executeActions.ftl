...
<@layout.emailLayout ; section>
  ...
  <#elseif section = "intro">
    Vous avez créé un compte ou vous avez été invité à rejoindre Potentiel. Pour poursuivre la création de votre compte nous vous invitons à cliquer sur le bouton ci-dessous. Il vous sera alors demandé de créer un mot de passe.
